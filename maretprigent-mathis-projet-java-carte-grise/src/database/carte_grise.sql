...
-- Table MARQUE
CREATE TABLE MARQUE (
    id_marque INT(4) AUTO_INCREMENT PRIMARY KEY,
    nom_marque VARCHAR(255) NOT NULL
);

-- Table MODELE
CREATE TABLE MODELE (
    id_modele INT(4) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE PROPRIETAIRE (
    id_proprietaire INT(4) AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE VEHICULE (
    id_vehicule INT(4) AUTO_INCREMENT PRIMARY KEY,
    matricule VARCHAR(50) NOT NULL,
    annee_sortie YEAR NOT NULL,
    poids INT(4) NOT NULL,
    puissance_chevaux INT(4) NOT NULL,
    puissance_fiscale INT(4) NOT NULL,
    id_modele INT(4) NOT NULL,
    FOREIGN KEY (id_modele) REFERENCES MODELE(id_modele) ON DELETE CASCADE
);

-- Table POSSEDER
CREATE TABLE POSSEDER (
    id_proprietaire INT(4) NOT NULL,
